...
<body>
  ...
  <section>
    <?php
      ...
      if ($resultado) {
          echo "<p>Datos de los proovedores con direccion: ". $_POST["fecha"] . "</p>";
          while($row = $resultado->fetch_assoc()) {
              echo sprintf("<p>ID Pedido:%s, Fecha Pedido:%s, ID Proovedor:%s</p>", $row['idPedido'], $row['fecha'], $row['idProovedor']);
          }

...
<body>
  <header>
    <h1>Busca datos en las tablas</h1>
    <hr>
  </header>

  <section>
    <form action="buscarDatosEnProovedor.php" method="post">
      <label for="direccionProovedor">Dirección del proovedor</label>
      <input type="text" id="direccionProovedor" name="direccion"/>
      <input type="submit" value="Buscar en proovedor"/>
    </form>
    <form action="buscarDatosEnPedido.php" method="post">
      <label for="fechaPedido">Fecha del pedido</label>
      <input type="text" id="fechaPedido" name="fecha"/>
      <input type="submit" value="Buscar en pedido"/>
    </form>
  </section>

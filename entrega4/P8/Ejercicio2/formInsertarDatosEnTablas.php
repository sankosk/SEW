...
<body>
  <header>
    <h1>Inserta datos en las tablas</h1>
    <hr>
  </header>

  <section>
    <form action="insertarEnProovedor.php" method="post">
      <label for="direccionProovedor">Dirección del proovedor</label>
      <input type="text" id="direccionProovedor" name="direccion"/>
      <input type="submit" value="Insertar proovedor"/>
    </form>
    <form action="insertarEnPedido.php" method="post">
      <label for="fechaPedido">Fecha del pedido</label>
      <input type="text" id="fechaPedido" name="fecha"/>
      <label for="idProovedor">ID del proovedor</label>
      <input type="text" id="idProovedor" name="id"/>
